...
def main():
    module = \
        AnsibleModule(argument_spec=dict(username=dict(required=True),
                      ...
                      url=dict(default='http://www.ibm.com/software/repositorymanaer/entitled/repository.xml'
                      , required=False, aliases=['repo']),
                      source=dict(default='/opt/IBM/InstallationManager/eclipse/tools/imutilsc'
                      , required=False)))
